...
$allGladiators = $pdo->query('SELECT g.id as gid, g.name as gname, country, weight, height, sword, shield, hand, winner, losing, likes, dislike,
c.name as cname
FROM gladiator g
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="hs-text">
                    ...
                    <h3>Discover here the list of all our fighters</h3>
    ...
    <div class="container">
        <div class="row">
            ...
            foreach ($allGladiators as $gladiator)
            {
                ...
                echo '<img width=300px src="uploads/glad' . $temporaryCounter++ . '.jpg" alt="">';
                echo '</div>';
                echo '<div class="ip-text" style="padding-left:30px">';
                echo '<div class="label"><span>'. $gladiator['cname'] .'</span></div>';
                echo '<h5><a href="gladiators_show.php?id=' . $gladiator['gid'] .'">' . $gladiator['gname'] . '</a></h5>';
                echo '<ul>';
                echo '<li><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-hand-thumbs-up" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

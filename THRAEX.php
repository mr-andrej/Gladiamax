    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                 ...
                 <div class="ip-item">
                     <div class="ip-pic">
                            <img src="img/instagram/insta-12.jpg" alt="">
                     </div>
                     <div class="ip-text">
                         <div class="label"><span>Spartacus</span></div>
                            <h5><a href="#">The THRAEX</a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> Aug 01, 72 B.C.</li>
                                <li><i class="fa fa-comment-o"></i> 20</li>
                            </ul>
                            <p>A curved dagger sharp on both sides of the blade.
                                He was protected by a small shield, often square in shape,
                                and by two leggings that reached up to the thighs.
                                 He wore a brimmed helmet.</p>
                     </div>
                 </div>

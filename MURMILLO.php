    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                 ...
                 <div class="ip-item">
                     <div class="ip-pic">
                            <img src="img/instagram/insta-15.jpg" alt="">
                     </div>
                     <div class="ip-text">
                         <div class="label"><span>Spartacus</span></div>
                            <h5><a href="#">The MURMILLO</a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> Aug 01, 72 B.C.</li>
                                <li><i class="fa fa-comment-o"></i> 20</li>
                            </ul>
                            <p>Armed with his sword, and protected by his scutum shield, helmet, ocrea and leather
                                manica, the mirmillon is the most heavily equipped gladiator.
                            </p>
                     </div>
                 </div>

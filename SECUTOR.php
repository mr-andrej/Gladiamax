    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                 ...
                 <div class="ip-item">
                     <div class="ip-pic">
                            <img src="img/instagram/insta-14.jpg" alt="">
                     </div>
                     <div class="ip-text">
                         <div class="label"><span>Spartacus</span></div>
                            <h5><a href="#">The SECUTOR</a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> Aug 01, 72 B.C.</li>
                                <li><i class="fa fa-comment-o"></i> 20</li>
                            </ul>
                            <p>Long shield, protected by a legging on the left leg. His remarkable helmet, without brim,
                                surmounted by a ridgeless crest, therefore offers less net grip than that of other
                                gladiators.</p>
                     </div>
                 </div>

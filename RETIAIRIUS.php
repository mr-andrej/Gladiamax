    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                 ...
                 <div class="ip-item">
                     <div class="ip-pic">
                            <img src="img/instagram/insta-11.jpg" alt="">
                     </div>
                     <div class="ip-text">
                         <div class="label"><span>Spartacus</span></div>
                            <h5><a href="#">The RETIAIRIUS</a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> Aug 01, 72 B.C.</li>
                                <li><i class="fa fa-comment-o"></i> 20</li>
                            </ul>
                            <p>Armed with the trident and a net, and had neither helmet nor shield.
                                His only protections were a shoulder pad, ankle brace and armband.</p>
                     </div>
                 </div>
            </div>

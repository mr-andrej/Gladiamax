    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8">
                 ...
                 <div class="ip-item">
                     <div class="ip-pic">
                            <img src="img/instagram/insta-13.jpg" alt="">
                     </div>
                     <div class="ip-text">
                         <div class="label"><span>Spartacus</span></div>
                            <h5><a href="#">The SAMNITE</a></h5>
                            <ul>
                                <li>by <span>Admin</span></li>
                                <li><i class="fa fa-clock-o"></i> Aug 01, 72 B.C.</li>
                                <li><i class="fa fa-comment-o"></i> 20</li>
                            </ul>
                            <p>Armed with a long rectangular shield (scutum), a helmet surmounted by a plume2,
                                a short sword and a legging on his left leg which reached up to his knee.</p>
                     </div>
                 </div>
